...
### Статус сценариев:
- **✅ Работают корректно**: 15 сценариев
...
### Проблема 1: Сохранение photo_file_id при загрузке документов
...
### Проблема 2: Активация ConversationHandler при установке ADD_REVIEW через глобальные обработчики
